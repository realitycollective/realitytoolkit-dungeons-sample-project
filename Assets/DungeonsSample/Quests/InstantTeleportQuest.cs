...
{
    /// <summary>
    /// For this quest, the user has to teleport at least once using the <see cref="InstantTeleportLocomotionProvider"/>s.
    /// </summary>
    public class InstantTeleportQuest : Quest, ILocomotionServiceHandler
    {
        ...
        {
            if (eventData.LocomotionProvider is InstantTeleportLocomotionProvider)
            {
                IsComplete = true;
            }
        }
